...
# 詳細: docs/SCP/review-guidelines/severity.md §3
...
PROTECTED_PATTERNS=(
  "^docs/SCP/[0-9]"             # 00-philosophy.md 〜 09-compiler-lens.md
  "^docs/SCP/README\.md$"
  "^docs/SCP/review-guidelines/"
  "^docs/SCP/bootstrap/CLAUDE.*\.md\.template$"
  "^\.trace-engine\.toml$"
